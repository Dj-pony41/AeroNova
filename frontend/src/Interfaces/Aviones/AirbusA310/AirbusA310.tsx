import '../../../Styles/Aviones/AirbusA310/AirbusA310.css'
...
const AirbusA310 = () => {
  ...
  const grupoSuperior = ['A', 'B', 'C', 'D']
  const grupoInferior = ['E', 'F', 'G', 'H']
  const columnasEjecutiva = 5
  const columnasTurista = 30 // 2 bloques de 30
  ...
  return (
    <div className="a310-container-horizontal">
      {renderEjecutiva()}
